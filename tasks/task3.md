...
Процесс стандартный и описани в `README.org`.
...
Рекомендуется освоить пакет консольных инструментов [https://cloud.google.com/sdk/gcloud/](gcloud) и использовать команду `gsutil` для доступа к данным в Google Storage.
